    ...
    <section>
      ...
      <div className="w-[100%] lg:w-[604px] h-[78px] lg:h-[48px] mb-[25px] ">
                ...
                <div className="h-[4px] bg-[#0E464F] rounded-full">
                  <div className="h-full bg-[#24A0B5] rounded-full" style={{ width: `${(step - 1) * 33.33}%` }}></div>
                </div>
              </div>
              ...
              <div className="w-[100%] lg:w-[604px] lg:h-[907px] lg:p-[24px] rounded-[32px] bg-[#08252B] border-0 border-[#0E464F] lg:border-[1px] ">
                {/* Profile Photo */}
                <div className="w-[100%] lg:w-[556px] lg:h-[323px] h-[328px] p-[16px] lg:p-[24px] rounded-[24px] border-[#07373F] border-[1px] text-center mb-[32px]">
                  <h2 className="text-left roboto text-[16px]/[150%]">Upload Profile Photo</h2>
                  <div className="w-[100%] lg:w-[508px] lg:h-[200px] mt-[24px] lg:bg-[#00000048]">
                    <div
                      className={`w-[240px] h-[240px] bottom-[20px] mt-[24px] m-auto relative cursor-pointer 
                  ...
                  {errors.profilePhoto && (
                    <p id="photo-error" className="text-red-500 text-sm mt-2" role="alert">
                      {errors.profilePhoto}
                    </p>
                  )}
                </div>
                ...
                <div className="w-[97%] lg:w-[556px] h-[80px] mt-[50px] lg:mt-[25px] flex flex-col ">
                  <label htmlFor="name" className="roboto text-[16px]/[150%] font-normal">
                    Enter your name *
                    <span className="sr-only">(Required)</span>
                  </label>
                  <input
                    id="name"
                    className={`p-[12px] w-[100%] lg:w-[556px] h-[48px] border-[#07373F] border-[1px] rounded-[12px] text-[16px] mt-[8px] transition focus:ring-2 focus:ring-[#24A0B5] focus:outline-none caret-[#24A0B5] ${errors.name ? 'border-red-500' : ''}`}
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div className="w-[97%] lg:w-[556px] h-[80px] mt-[32px] flex flex-col ">
                  <label htmlFor="email" className="roboto text-[16px]/[150%] font-normal">
                    Enter your email *
                  </label>
                  ...
                  <input
                    id="email"
                    className={`p-[12px] pl-[40px] w-[100%] lg:w-[556px] h-[48px] flex border-[#07373F] border-[1px] rounded-[12px] text-[16px] mt-[8px] transition focus:ring-2 focus:ring-[#24A0B5] focus:outline-none ${errors.email ? 'border-red-500' : ''}`}
                    type="email"
                    name="email"
                  ...
                  />
                  {errors.email && <p id="email-error" className="text-red-500 text-sm" role="alert">{errors.email}</p>}
                </div>

                <hr className="h-[4px] text-[#07373F]" />
                {/* TEXTAREA */}
                <div className="w-[97%] lg:w-[556px] h-[159px] mt-[32px] flex flex-col">
                  <label htmlFor="specialRequest" className="roboto text-[16px]/[150%] font-normal mb-[8px]">
                    Special request?
                  </label>
                  <textarea
                    id="specialRequest"
                    maxLength={100}
                    className="w-[100%] lg:w-[556px] h-[127px] p-[12px] rounded-[12px] resize-none focus:bg-[#083C46] border-[#07373F] border-[1px] text-[16px]/[150%]  focus:ring-2 focus:ring-[#24A0B5] focus:outline-none "
                ...
                <div className="flex justify-between flex-col h-[112px] lg:flex-row mt-[32px]">
                  ...
                  <Button variant="select" btnName={"Get My Free Ticket"} onClick={handleGetTicket} aria-label="Proceed to Ticket Confirmation" />
                </div>
              </div>
      </main>
    </section>
